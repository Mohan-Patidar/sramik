                ...
                <div class="row">
                    <div class="col-md-12 mx-0">
                        <form id="msform">
                            ...
                            <fieldset>
                            <form method="Post" id="account_info" action="javascript:void(0)">
                                <div class="form-card">
                                ...
                                </div><input type="button" id="account_btn" class="action-button" value="Register" /> <input type="button" name="next" class="next action-button" value="Next Step" />
                            </form>
                            </fieldset>
                            <fieldset>
                                <div class="form-card">
