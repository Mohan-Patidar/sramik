...
<section class="bg-light">
    ...
    <section class="container py-5">
        ...
        <div class="row pb-4">
            ...
            <!-- Start Contact Form -->
            <div class="col-lg-8 ">
                <form class="contact-form row" method="post" action="{{url('contact')}}" role="form" enctype="multipart/form-data">
                        {{csrf_field()}}
                   ...
                   <!-- End Input Company Name -->
                    ...
                    <div class="col-12">
                        <div class="form-floating mb-3">
                            <textarea class="form-control light-300" rows="8" placeholder="Message" name="message" id="floatingtextarea"></textarea>
